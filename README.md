...
To test our application, we ran two instances of  SAFE on the computer locally at different ports, which served as two different and independent nodes (let’s say node A and node B). From both of them, we connected to the blockchain network and shared files using file keys.
...
<h3>1. git clone https://github.com/RISHIxcix/BLOCKNEST.git</h3>
<h3>1.2 cd BLockNest</h3>
